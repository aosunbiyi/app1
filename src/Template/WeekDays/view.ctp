 ...
 * @var \App\Model\Entity\WeekDay $weekDay
 */
?>
							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/week-days" class="m-nav__link">
                                        ...
                                        <div class="m-dropdown__body">
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="/week-days/edit/<?php echo $weekDay->id ?>" class="m-nav__link">
...
<div class="m-portlet m-portlet--creative m-portlet--first m-portlet--bordered-semi">
   ...
   <?php if (!empty($weekDay->rooms)): ?>
        <table  class="table table-striped- table-bordered table-hover table-checkable" >
            ...
            <?php foreach ($weekDay->rooms as $rooms): ?>
            <tr>

            <td><?= h($rooms->room_name) ?></td>
               
                <td><?= h($rooms->room_type->room_type_name) ?></td>
                <td><?= h($rooms->wing->wing_name) ?></td>
