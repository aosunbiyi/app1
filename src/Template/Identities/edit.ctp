...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($identity,['class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('identity_name',['class'=>'form-control m-input m-input--square']);
