...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($seasonType,['class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('season_type_name',['class'=>'form-control m-input m-input--square']);
