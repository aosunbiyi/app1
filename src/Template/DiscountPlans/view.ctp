							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/discount-plans" class="m-nav__link">
                                        ...
                                        <div class="m-dropdown__body">
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="/discount-plans/edit/<?php echo $discountPlan->id ?>" class="m-nav__link">
...
<div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
    ...
    <tr>
            <th scope="row"><?= __('Plan Category') ?></th>
            <td><?= h($discountPlan->plan_category) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Id') ?></th>
            <td><?= $this->Number->format($discountPlan->id) ?></td>
        </tr>
        <tr>
