...
echo $this->Form->control('from_day',['type'=>'day','class'=>'form-control m-input m-input--square']);
echo $this->Form->control('to_day',['type'=>'day','class'=>'form-control m-input m-input--square']);
echo $this->Form->control('from_month',['type'=>'month','class'=>'form-control m-input m-input--square']);
echo $this->Form->control('to_month',['type'=>'month','class'=>'form-control m-input m-input--square']);
