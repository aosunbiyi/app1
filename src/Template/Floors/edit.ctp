...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($floor,['class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('wing_id',['class'=>'form-control m-input m-input--square'], ['options' => $wings]);
echo $this->Form->control('floor_name',['class'=>'form-control m-input m-input--square']);
