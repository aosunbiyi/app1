                                        ...
                                        <div class="m-dropdown__body">
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="/floors/edit/<?php echo $floor->id ?>" class="m-nav__link">
...
<div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
    ...
    <tr>
        ...
        <tr>
            ...
            <td><?= $this->Number->format($floor->sort_key) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
            <?= $this->Text->autoParagraph(h($floor->description)); ?>
            </td>
        </tr>
    </table>
