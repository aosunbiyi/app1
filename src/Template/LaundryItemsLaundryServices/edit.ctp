...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $laundryItemsLaundryService->laundry_item_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $laundryItemsLaundryService->laundry_item_id)]
            )
        ?></li>
...
<div class="laundryItemsLaundryServices form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Laundry Items Laundry Service') ?></legend>
        <?php
        ?>
    </fieldset>
