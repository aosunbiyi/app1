...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($hotelRepresentative,['class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('hotel_representative_name',['class'=>'form-control m-input m-input--square']);
