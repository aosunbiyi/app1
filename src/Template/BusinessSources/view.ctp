 ...
 * @var \App\Model\Entity\BusinessSource $businessSource
 */
?>
							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/business-sources" class="m-nav__link">
                                        ...
                                        <div class="m-dropdown__body">
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="/business-sources/edit/<?php echo $businessSource->id ?>" class="m-nav__link">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="/business-sources" class="m-nav__link">
                                                                    ...
                                                                    <span class="m-nav__link-text">
                                                                    List Business Sources
                                                                    </span>
                                                                </a>
                                                            </li>
                                                            <li class="m-nav__item">
                                                                <a href="/business-sources/add" class="m-nav__link">
...
<div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
										...
										<div class="m-portlet__head-caption">
											<div class="m-portlet__head-title">
												...
												<h2 class="m-portlet__head-label m-portlet__head-label--warning">
													<span>
                                                    <?= h($businessSource->business_source_name) ?>
													</span>
												</h2>
											</div>
										</div>
    ...
    <tr>
            <th scope="row"><?= __('Business Source Type') ?></th>
        ...
        <tr>
            ...
            <td><?= h($businessSource->alias) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Business Source Name') ?></th>
