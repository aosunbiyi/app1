 ...
 * @var \App\Model\Entity\CardTypePrefix $cardTypePrefix
 */
?>
...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($cardTypePrefix,['class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('settlement_type_id',['class'=>'form-control m-input m-input--square'], ['options' => $settlementTypes, 'empty' => true]);
