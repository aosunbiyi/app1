...
<div class="m-portlet m-portlet--mobile">
        ...
        <thead>
            <tr>
            <th scope="col"><?= $this->Paginator->sort('rate_name') ?></th>
             
                <th scope="col"><?= $this->Paginator->sort('rate_type_id') ?></th>
        ...
        <tbody>
            ...
            <td><?= h($rate->rate_name) ?></td>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $rate->id],['class'=>'btn btn-primary btn-sm']) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $rate->id],['class'=>'btn btn-success btn-sm']) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $rate->id],['class'=>'btn btn-danger btn-sm'], ['confirm' => __('Are you sure you want to delete # {0}?', $rate->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
