                                        ...
                                        <div class="m-dropdown__body">
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="/ExtraCharges" class="m-nav__link">
...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($extraCharge,['class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('extra_charge_category_id',['class'=>'form-control m-input m-input--square'], ['options' => $extraChargeCategories]);
echo $this->Form->control('extra_charge_name',['class'=>'form-control m-input m-input--square']);
echo $this->Form->control('description',['class'=>'form-control m-input m-input--square']);

echo $this->Form->control('rate',['class'=>'form-control m-input m-input--square']);
