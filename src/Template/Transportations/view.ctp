 ...
 * @var \App\Model\Entity\Transportation $transportation
 */
?>
                                        ...
                                        <div class="m-dropdown__body">
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="/transportations/edit/<?php echo $transportation->id ?>" class="m-nav__link">
...
<div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
    ...
    <table class="table table-stripped">
        ...
        <tr>
            <th scope="row"><?= __('Transportation Type') ?></th>
