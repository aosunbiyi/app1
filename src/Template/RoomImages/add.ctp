                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="m-subheader__title m-subheader__title--separator">
                                  Upload Image for <?php echo $room->room_name ?>
                                </h3>
...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($roomImage,['type' => 'file','class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('room_id',  ['type' => 'hidden', 'value' => $room->id]);
echo $this->Form->control('file', ['type' => 'file', 'required' => true,'class'=>'form-control m-input m-input--square']);
