...
<div class="m-portlet m-portlet--mobile">
        ...
        <thead>
            ...
            <th scope="col"><?= $this->Paginator->sort('amenity_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('amenity_type_id') ?></th>
             
                <th scope="col">                
                <?= $this->Paginator->sort('amenity_logo') ?></th>
        ...
        <tbody>
            ...
            <td><?= h($amenity->amenity_name) ?></td>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $amenity->id],['class'=>'btn btn-primary btn-sm']) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $amenity->id],['class'=>'btn btn-success btn-sm']) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $amenity->id],['class'=>'btn btn-danger btn-sm'], ['confirm' => __('Are you sure you want to delete # {0}?', $amenity->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
