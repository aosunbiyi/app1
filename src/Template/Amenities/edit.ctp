...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($amenity,['type' => 'file','class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('amenity_type_id',['class'=>'form-control m-input m-input--square'], ['options' => $amenityTypes, 'empty' => true]);
echo $this->Form->control('amenity_name',['class'=>'form-control m-input m-input--square']);
